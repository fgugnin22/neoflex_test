...
const Header = () => {
  ...
  const addedToCartAmount = state.addedToCart.reduce(
    ...
    <div className="w-full h-[60px] flex justify-between items-center">
      ...
      <nav className="flex h-full items-center gap-9">
        <Link className="relative" to={ROUTES.favorites}>
          <svg
            className="fill-secondary hover:fill-red-500 transition"
            width="23"
            height="20"
            viewBox="0 0 23 20"
          ...
          {addedToFavoritesAmount > 0 && (
            <span className=" absolute w-[20px] h-[20px] flex items-center justify-center -top-3 -right-3 text-white rounded-full bg-price">
              {addedToFavoritesAmount}
            </span>
          )}
        </Link>
        <Link className="relative mr-2" to={ROUTES.cart}>
          <svg
            className="fill-secondary hover:fill-main transition"
            width="24"
            height="25"
            viewBox="0 0 24 25"
            fill="none"
          ...
          {addedToCartAmount > 0 && (
            <span className=" absolute w-[20px] h-[20px] flex items-center justify-center -top-2 -right-3 text-white rounded-full bg-price">
              {addedToCartAmount}
            </span>
          )}
        </Link>
